...
// Create a smartRequire function in global scope to work on Node or browser
...
(function() {
    ...
    describe('jsonpipe', function() {
        ...
        describe('verify the iterface', function() {
            ...
            it('should return XMLHttpRequest object when called with url, success and onHeaders attributes',
                function() {
                    var xhr = jsonpipe.flow(testUrl, {
                        "success": function() {},
                        "onHeaders": function() {}
        ...
        describe('verify success scenarios', function() {
            ...
            it('should process a multi chunk JSON response separated with the provided option delimiter',
                function(done) {
                    var chunkCount = 0,
                        xhr = jsonpipe.flow(testUrl, {
                            "delimiter": "\r\r",
